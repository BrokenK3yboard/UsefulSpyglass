...
public class MarkedEntities {
    ...
    public ClientboundSetEntityDataPacket createPacket(Entity entity, boolean shouldGlow) {
        ...
        packedItems.add(new SynchedEntityData.DataValue<>(EntityAccessor.getDATA_SHARED_FLAGS_ID().hashCode(), EntityAccessor.getDATA_SHARED_FLAGS_ID().getSerializer(), isGlowing));
