...
public class WailaTickHandlerMixin {
    ...
    @WrapOperation(method = "tickClient", at = @At(value = "INVOKE", target = "Lsnownee/jade/api/config/IWailaConfig$IConfigGeneral;shouldDisplayTooltip()Z"), require = 0, remap = false)
